...
const Category = () => {
    return (
        ...
        <Swiper 
         ...
         <div className='flex drop-shadow-xl bg-white hover:bg-sky-400 hover:text-white text-lg hover:border-2 border-2 hover:border-black justify-center items-center px-5 py-3 gap-1 md:gap-5 mb-10 rounded-md'>
          ...
          <SwiperSlide className=''>
         <div className='flex shadow-xl bg-white hover:bg-sky-400 hover:text-white text-lg hover:border-2 border-2 hover:border-black justify-center items-center px-5 gap-1 md:gap-5 py-3 mb-10 rounded-md'>
         ...
         <div className='flex shadow-xl bg-white hover:bg-sky-400 hover:text-white text-lg hover:border-2 border-2 hover:border-black justify-center items-center gap-1 md:gap-5 px-5 py-3 mb-10 rounded-md'>
         ...
         <div className='flex shadow-xl bg-white hover:bg-sky-400 hover:text-white text-lg hover:border-2 border-2 hover:border-black justify-center items-center gap-1 md:gap-5 px-0 py-3 mb-10 rounded-md'>
